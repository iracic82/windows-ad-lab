...
Start-Transcript -Path "C:\userdata_dc.log" -Append

Write-Host "==== Starting DC Userdata Configuration ===="
...
try {
    New-Item -ItemType Directory -Path "C:\dns-import" -Force | Out-Null
    New-Item -ItemType Directory -Path "C:\infoblox" -Force | Out-Null
    Write-Host "Created C:\dns-import and C:\infoblox directories"
} catch {
...
Write-Host "==== DC Userdata Configuration Completed ===="
Write-Host "Rebooting in 30 seconds to apply hostname change..."
Stop-Transcript

# Reboot to apply computer name
shutdown /r /t 30 /c "Rebooting to apply DC configuration"
</powershell>
